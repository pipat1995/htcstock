                ...
                <div class="form-row">
                    ...
                    <div class="col-md-6 mb-6">
                        <label for="validationWarranty"><strong>Date</strong> <span
                                style="color: red;">*</span></label>
                        <input type="date" class="form-control" id="validationWarranty" name="warranty"  required>
                        <div class="invalid-feedback">
                            Please provide a valid Ivoice No.
                        </div>
                    </div>
                ...
                <div class="form-row">
                    <div class="col-md-4 mb-4">
                        <label for="validationWarranty"><strong>Title/Position</strong> <span
                                style="color: red;">*</span></label>
                        <input type="text" class="form-control" id="validationWarranty" name="warranty"  required>
                        <div class="invalid-feedback">
                            Please provide a valid Ivoice No.
                        </div>
                    </div>
