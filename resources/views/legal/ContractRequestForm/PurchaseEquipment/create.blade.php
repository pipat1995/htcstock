            ...
            <form class="needs-validation" novalidate
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-8 mb-8 hide-contract" id="contractType1">
                        <ul>
                            <li class="li-none-type"><input type="number" class="type-contract-input" min="0"> <span>of the total
...
<script src="{{asset('assets\js\legals\contractRequestForm\agreements\purchaseequipment.js')}}"></script>
@endsection